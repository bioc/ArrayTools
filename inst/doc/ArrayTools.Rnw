...
eSet <- createExpressionSet (pData=pDataExample,  exprs = exprsExample, annotation = "hugene10stprobeset")
dim(eSet)
@
...
either \verb"hugene10stprobeset" or \verb"mogene10stprobeset" as the value for the 
